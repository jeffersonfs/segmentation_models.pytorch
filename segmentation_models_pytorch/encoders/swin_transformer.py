...
class SwinTransformerEncoder(SwinTransformer, EncoderMixin):
    ...
    def make_dilated(self, *args, **kwargs):
        raise ValueError("SwinTransformer encoder does not support dilated mode")

    def set_in_channels(self, in_channels, *args, **kwargs):
        if in_channels != 3:
            raise ValueError("SwinTransformer encoder does not support in_channels setting other than 3")
...
swin_transformer_encoders = {
    "swin_t": {
        ...
        "pretrained_settings": {
            "imagenet22k": get_pretrained_cfg("swin_tiny_patch4_window7_224_22k"),
        },
        "params": dict(
            patch_size=4,
            num_heads=[3, 6, 12, 24],
    ...
    "swin_s": {
        "encoder": SwinTransformerEncoder,
        "pretrained_settings": {
            "imagenet22k": get_pretrained_cfg("swin_small_patch4_window7_224_22k"),
        },
        "params": dict(
            patch_size=4,
            num_heads=[3, 6, 12, 24],
    ...
    "swin_b": {
        "encoder": SwinTransformerEncoder,
        "pretrained_settings": {
            "imagenet22k": get_pretrained_cfg("swin_base_patch4_window7_224_22k"),
        },
        "params": dict(
            embed_dim=128,
            patch_size=4,
    ...
    "swin_b_384": {
        "encoder": SwinTransformerEncoder,
        "pretrained_settings": {
            "imagenet22k": get_pretrained_cfg("swin_base_patch4_window12_384_22k"),
        },
        "params": dict(
            embed_dim=128,
            patch_size=4,
    ...
    "swin_l": {
        "encoder": SwinTransformerEncoder,
        "pretrained_settings": {
            "imagenet22k": get_pretrained_cfg("swin_large_patch4_window7_224_22k"),
        },
        "params": dict(
            embed_dim=192,
            patch_size=4,
